...
def main():
    ...
    user_id = st.text_input("Enter Your User ID", key="absorption_user_input")

    # Initialize session state variables
    if "absorption_user_id" not in st.session_state:
        st.session_state.absorption_user_id = None
    ...
    # Process user input
    if user_id:
        st.session_state.absorption_user_id = user_id

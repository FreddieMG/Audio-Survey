...
def main():
    ...
    user_id = st.text_input("Enter Your User ID", key="rotation_speed_user_input")

    # Initialize session state variables
    if "rotation_speed_user_id" not in st.session_state:
        st.session_state.rotation_speed_user_id = None
    ...
    # Process user input
    if user_id:
        st.session_state.rotation_speed_user_id = user_id
        ...
        if not st.session_state.rotation_speed_completed and st.session_state.rotation_speed_current_audio_index < total_audios:
            ...
            with st.form(key="transcription_form"):
                ...
                transcription = st.text_area(
                    ...
                    key=f"rotation_speed_transcription_{user_id}_{audio_number}",
                )
